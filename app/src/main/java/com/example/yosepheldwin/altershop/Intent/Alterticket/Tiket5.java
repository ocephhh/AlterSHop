...
public class Tiket5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tiket5);
        ...
        pesan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                int jumlah;
                int satuan;
                int total = quantitas * 70000;

                Intent hasil = new Intent(Tiket5.this,TotalTiket2.class);
