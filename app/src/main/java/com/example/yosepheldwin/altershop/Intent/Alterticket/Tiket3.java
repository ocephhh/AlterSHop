...
public class Tiket3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tiket3);
        ...
        pesan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                int total = quantitas * 90000;

                Intent hasil = new Intent(Tiket3.this, TotalTiket3.class);
